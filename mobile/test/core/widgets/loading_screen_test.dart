...
void main() {
  group('LoadingScreen', () {
    testWidgets('should display loading screen with message', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: LoadingScreen(message: 'Cargando...'),
        ),
      );
    ...
    testWidgets('should display loading indicator when message is not provided', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: LoadingScreen(),
        ),
