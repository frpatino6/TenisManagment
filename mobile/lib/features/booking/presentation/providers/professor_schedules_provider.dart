...
class SchedulePeriodGroup {
  ...
  SchedulePeriodGroup({required this.period, required this.schedules});
}
...
final professorSchedulesDataProvider = FutureProvider.autoDispose
    .family<ProfessorSchedulesResponse, String>((ref, professorId) async {
...
final availableDatesProvider = Provider.autoDispose
    .family<List<DateTime>, ProfessorSchedulesResponse>((ref, schedulesData) {
...
final filteredSchedulesByDateProvider = Provider.autoDispose
    .family<Map<String, List<SchedulePeriodGroup>>, ProfessorSchedulesResponse>(
      (ref, schedulesData) {
