...
class ScheduleService {
  ...
  Future<ProfessorSchedulesResponse> getProfessorSchedules(String professorId) async {
    try {
      ...
      final response = await client.get(
        Uri.parse('$_baseUrl/student-dashboard/professors/$professorId/schedules'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        final errorMessage = errorData?['error'] as String? ?? 'Error al obtener horarios';
