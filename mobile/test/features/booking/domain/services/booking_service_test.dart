...
void main() {
  ...
  group('BookingService', () {
    ...
    group('getProfessors', () {
      test('should return list of ProfessorBookingModel when request succeeds', () async {
    ...
    group('getAvailableSchedules', () {
      test('should return list of AvailableScheduleModel when request succeeds', () async {
        const idToken = 'test-token';
        ...
        final result = await bookingService.getAvailableSchedules(professorId);
