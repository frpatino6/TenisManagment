  ...
  describe('findById', () => {
    it('should find a message by ID', async () => {
      ...
      mockMessageModel.findById.mockReturnValue({
        lean: jest.fn().mockResolvedValue(mockMessage as any as any)
      } as any);
  ...
  describe('findByConversation', () => {
    it('should find messages by conversation ID with default pagination', async () => {
      ...
      const mockQuery = {
        ...
        lean: jest.fn().mockResolvedValue(mockMessages as any as any)
      };
  ...
  describe('markAsRead', () => {
    it('should mark a message as read', async () => {
      ...
      mockMessageModel.findByIdAndUpdate.mockReturnValue({
        lean: jest.fn().mockResolvedValue(mockUpdatedMessage as any as any)
      } as any);
